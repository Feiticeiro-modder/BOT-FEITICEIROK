...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=5519971050451:+55 19 97105-0451\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
const config = {
    A187: '❄Feiticeiro BOT❄',
    nomer: 'wa.me/5519971050451',
    aktif: '24 JAN',
    youtube: 'https://youtube.com/channel/UCELdGx32blEi8ghcoM22Ucg',
    whatsapp: 'https://chat.whatsapp.com/LmVidpyaJTYEf7j1ykDEIw',
   ...
   switch (prefix) {
      ...
      case 'info':
       ...
       case 'nulis':
           nulis(value)
               .then(data => {
                   client.sendMessage(id, '[❗] PROCURANDO',MessageType.text)
